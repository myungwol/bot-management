# utils/database.py (알림 역할 ID가 추가된 완벽 최종본)
...
ROLE_ID_CONFIG = {
    ...
    "staff_festival": 1405325608254181417, # 祭りの委員 (스태프) 역할 ID
    ...
    # --- 나이 관련 역할 ---
    "age_70s_role": 1405325674499276840,
    "age_80s_role": 1405325679142375435,
    "age_90s_role": 1405325683822952603,
    "age_00s_role": 1405325688281628804,
    "age_private_role": 1405325668845097124,

    # --- [추가된 부분] 알림 역할 ---
    "notify_festival": 1405325695567269919, # "祭り" 이벤트 알림 역할 ID
    "notify_voice": 1405325700222943374,    # "通話" 알림 역할 ID
    "notify_friends": 1405661009947005060,  # "友達" 알림 역할 ID
    "notify_disboard": 123456789012345678, # "ディスボード" 알림 역할 ID
    "notify_up": 1405530171020152902,       # "アップ" 알림 역할 ID
}
...
AUTO_ROLE_MAPPING = [
    {
        ...
        "role_id": 1405489827884830742
    },
    {
        "field_name": "性別",
        "keywords": ["女", "女性", "おんな", "オンナ", "woman", "female"],
        "role_id": 1405489828908367972
    },
]
