...
ONBOARDING_CHOICES = {
    ...
    "birth_year_groups": {
        "2000s": [{"label": f"{year}년생", "value": str(year)} for year in range(2009, 1999, -1)],
        "1990s": [{"label": f"{year}년생", "value": str(year)} for year in range(1999, 1989, -1)],
        "1980s": [{"label": f"{year}년생", "value": str(year)} for year in range(1989, 1979, -1)],
        "1970s": [{"label": f"{year}년생", "value": str(year)} for year in range(1979, 1969, -1)],
...
UI_EMBEDS = {
    ...
    "onboarding_guide_rules": {"title": "③ 서버 규칙", "description": "모두가 즐겁게 지내기 위해 다음 규칙을 지켜주세요.\n\n- **존중**: 다른 멤버를 존중하고, 비방이나 괴롭힘은 금지입니다.\n- **안전**: 개인정보 공개나 부적절한 콘텐츠 게시는 금지입니다.\n- **신고**: 문제가 발생하면 즉시 <#채널ID>를 통해 관리자에게 신고해주세요.\n\n자세한 내용은 <#채널ID>에서 확인할 수 있습니다.", "color": 0x5865F2, "footer": {"text": "3/7 단계"}},
    "onboarding_guide_channels": {"title": "④ 주요 채널 소개", "description": "서버에는 다양한 목적의 채널이 있습니다.\n\n- <#채널ID>: 메인 잡담 공간입니다.\n- <#채널ID>: 음성 채널에 참여하여 대화를 즐길 수 있습니다.\n- <#채널ID>: 함께 게임할 친구를 찾을 수 있습니다.\n\n다양한 채널이 있으니, 자유롭게 둘러보세요!", "color": 0x5865F2, "footer": {"text": "4/7 단계"}},
    "onboarding_guide_roles": {"title": "⑤ 역할 받기", "description": "자신의 프로필을 꾸미기 위해 <#채널ID>에서 역할을 받아보세요.\n\n- **게임**: 플레이하는 게임이나 플랫폼을 선택할 수 있습니다.\n- **알림**: 특정 활동(음성채팅 시작 등)에 대한 알림을 받을지 선택할 수 있습니다.\n- **정보**: 자신의 성별이나 나이대 등을 다른 멤버에게 표시할 수 있습니다.", "color": 0x5865F2, "footer": {"text": "5/7 단계"}},
    "onboarding_guide_staff": {"title": "⑥ 스태프 소개", "description": "어려운 일이 있다면 아래 스태프에게 문의하세요.\n\n- **촌장/부촌장**: 서버의 최고 책임자입니다.\n- **마을사무소 직원**: 서버 운영 전반을 지원합니다.\n- **경찰관**: 규칙 위반 대응 및 분쟁 중재를 담당합니다.\n\n스태프 목록은 <#채널ID>에서 확인할 수 있습니다.", "color": 0x5865F2, "footer": {"text": "6/7 단계"}},
    "onboarding_guide_intro": {"title": "⑦ 주민 등록증 작성", "description": "마지막으로, 자기소개인 '주민 등록증'을 작성해봅시다!\n\n아래 버튼을 눌러 당신의 이름, 취미 등을 기입해주세요.\n제출 후, 마을사무소 직원이 확인하고 승인하면 정식 주민으로 인정됩니다.", "color": 0x5865F2, "footer": {"text": "7/7 단계"}},
    "welcome_embed": {"title": "🎉 {guild_name}에 오신 것을 환영합니다!", "description": "{member_mention}님, 안녕하세요!\n\n우선, 서버 안내를 읽고 자기소개를 작성해주세요.", "color": 0x3498DB},
    "farewell_embed": {"title": "👋 다음에 또 만나요", "description": "**{member_name}**님이 마을을 떠났습니다.", "color": 0x99AAB5},
    "panel_roles": {"title": "📖 역할 부여", "description": "아래 메뉴에서 카테고리를 선택하고, 자신에게 필요한 역할을 받아가세요.", "color": 0x5865F2},
    "panel_onboarding": {"title": "📝 마을사무소・안내소", "description": "처음 오신 분은 먼저 '안내 읽기' 버튼을 눌러 서버 이용 방법을 확인해주세요.", "color": 0x5865F2},
    "embed_onboarding_approval": {"title": "📝 새로운 주민 등록 신청", "description": "{member_mention}님이 주민 등록증을 제출했습니다.", "color": 0xE67E22},
    "panel_nicknames": {"title": "✒️ 이름 변경", "description": "마을에서 사용할 이름을 변경하고 싶다면, 아래 버튼을 통해 신청해주세요.", "color": 0x5865F2},
    "embed_main_chat_welcome": {"description": "🎉 {member_mention}님이 새로운 주민이 되었습니다! 앞으로 잘 부탁드립니다!", "color": 0x2ECC71},
    "panel_warning": {"title": "🚨 경고 관리 패널", "description": "서버 규칙을 위반한 유저에게 아래 버튼을 통해 경고를 부여할 수 있습니다.\n\n**이 기능은 `경찰관`만 사용할 수 있습니다.**", "color": 15548997},
    "log_warning": {"title": "🚨 경고 발급 알림", "color": 15548997},
    ...
    "panel_commerce": {"title": "🏪 상점 & 판매함", "description": "> 아이템을 사거나, 잡은 물고기 등을 팔 수 있습니다.", "color": 0x5865F2, "fields": [{"name": "📢 오늘의 주요 시세 변동", "value": "{market_updates}", "inline": False}]},
    "panel_fishing_river": {"title": "🏞️ 강의 낚시터", "description": "> 강가에서 여유롭게 낚시를 즐겨보세요.\n> 아래 버튼을 눌러 낚시를 시작합니다.", "color": 0x5865F2},
    "panel_fishing_sea": {"title": "🌊 바다의 낚시터", "description": "> 넓은 바다에서 월척의 꿈을 쫓아보세요!\n> 아래 버튼을 눌러 낚시를 시작합니다.", "color": 0x3498DB},
    "panel_atm": {"title": "🏧 ATM", "description": "> 아래 버튼으로 다른 주민에게 코인을 보낼 수 있습니다.", "color": 0x2ECC71},
    "panel_profile": {"title": "📦 소지품", "description": "> 자신의 소지금, 아이템, 장비 등을 확인할 수 있습니다.", "color": 0x5865F2},
    "panel_dice_game": { "title": "🎲 주사위 게임", "description": "> 운을 시험해보시겠어요?\n> 아래 버튼으로 게임을 시작하고, 10코인 단위로 베팅할 수 있습니다.", "color": 0xE91E63 },
    ...
    "panel_slot_machine": { "title": "🎰 슬롯머신", "description": "> 오늘의 운세를 시험해보세요!\n> 아래 버튼으로 게임을 시작하고, 100코인 단위로 베팅할 수 있습니다.", "color": 0xFF9800 },
    ...
    "panel_rps_game": { "title": "✊✌️✋ 가위바위보 방", "description": "> 다른 주민과 가위바위보 승부!\n> 아래 버튼을 눌러 방을 만들고, 참가자와 승부할 수 있습니다.", "color": 0x9B59B6 },
    ...
    "panel_tasks": {"title": "✅ 오늘의 할 일", "description": "> 아래 버튼을 눌러 매일 출석 보상을 받거나 퀘스트를 확인할 수 있습니다!", "color": 0x4CAF50},
    "log_daily_check": {"title": "✅ 출석 체크 완료", "description": "{user_mention}님이 출석하고 **`{reward}`**{currency_icon}을 받았습니다.", "color": 0x8BC34A},
    "panel_farm_creation": {"title": "🌾 나만의 농장 만들기!", "description": "> 아래 버튼을 눌러 당신만의 농장(개인 스레드)을 만듭니다.\n> 자신만의 공간에서 작물을 키워보세요!", "color": 0x8BC34A},
    "farm_thread_welcome": {"title": "{user_name}님의 농장", "description": "환영합니다! 이곳은 당신만의 농장입니다.\n\n**시작하는 법:**\n1. 먼저 상점에서 '낡은 괭이'와 '씨앗'을 구매합니다.\n2. 아래 버튼으로 밭을 갈고 씨앗을 심어보세요!", "color": 0x4CAF50},
    "log_coin_gain": { "title": "🪙 코인 획득 알림", "description": "{user_mention}님이 활동 보상으로 코인을 획득했습니다.", "color": 0x2ECC71, "fields": [{"name": "획득자", "value": "{user_mention}", "inline": True}, {"name": "획득 코인", "value": "+{amount}{currency_icon}", "inline": True}], "footer": {"text": "축하합니다!"} },
    ...
    "panel_champion_board": {
        "title": "🏆 종합 챔피언 보드 🏆",
        "description": "각 분야에서 가장 빛나는 종합 1위 주민을 소개합니다!\n아래 버튼으로 자신의 상태를 확인하거나 상세 랭킹을 볼 수 있습니다.",
        "color": 0xFFD700,
        "fields": [
            {"name": "👑 종합 레벨", "value": "{level_champion}", "inline": False},
            {"name": "🎙️ 음성 채팅", "value": "{voice_champion}", "inline": False},
            {"name": "💬 채팅", "value": "{chat_champion}", "inline": False},
            {"name": "🎣 낚시", "value": "{fishing_champion}", "inline": False},
            {"name": "🌾 수확", "value": "{harvest_champion}", "inline": False}
        ],
...
UI_PANEL_COMPONENTS = [
    ...
    {"component_key": "post_anonymous_message_button", "panel_key": "anonymous_board", "component_type": "button", "label": "익명으로投稿하기", "style": "secondary", "emoji": "✍️", "row": 0, "order_in_row": 0},
    ...
    {"component_key": "open_market", "panel_key": "commerce", "component_type": "button", "label": "판매함 (아이템 판매)", "style": "danger", "emoji": "📦", "row": 0, "order_in_row": 1},
    {"component_key": "open_inventory", "panel_key": "profile", "component_type": "button", "label": "소지품 보기", "style": "primary", "emoji": "📦", "row": 0, "order_in_row": 0},
    {"component_key": "start_fishing_river", "panel_key": "panel_fishing_river", "component_type": "button", "label": "강에서 낚시하기", "style": "primary", "emoji": "🏞️", "row": 0, "order_in_row": 0},
    {"component_key": "start_fishing_sea", "panel_key": "panel_fishing_sea", "component_type": "button", "label": "바다에서 낚시하기", "style": "secondary", "emoji": "🌊", "row": 0, "order_in_row": 1},
    {"component_key": "start_transfer", "panel_key": "atm", "component_type": "button", "label": "코인 보내기", "style": "success", "emoji": "💸", "row": 0, "order_in_row": 0},
    {"component_key": "start_dice_game", "panel_key": "panel_dice_game", "component_type": "button", "label": "주사위 게임 시작", "style": "primary", "emoji": "🎲", "row": 0, "order_in_row": 0},
    {"component_key": "start_slot_machine", "panel_key": "panel_slot_machine", "component_type": "button", "label": "슬롯머신 플레이", "style": "success", "emoji": "🎰", "row": 0, "order_in_row": 0},
    {"component_key": "create_rps_room", "panel_key": "panel_rps_game", "component_type": "button", "label": "방 만들기", "style": "secondary", "emoji": "✊", "row": 0, "order_in_row": 0},
    {"component_key": "do_daily_check", "panel_key": "panel_tasks", "component_type": "button", "label": "출석 체크", "style": "success", "emoji": "✅", "row": 0, "order_in_row": 0},
    {"component_key": "open_quests", "panel_key": "panel_tasks", "component_type": "button", "label": "퀘스트 확인", "style": "primary", "emoji": "📜", "row": 0, "order_in_row": 1},
    {"component_key": "create_farm", "panel_key": "panel_farm_creation", "component_type": "button", "label": "농장 만들기", "style": "success", "emoji": "🌱", "row": 0, "order_in_row": 0},
]
SETUP_COMMAND_MAP = {
    ...
    "log_warning":   {"type": "channel", "cog_name": "WarningSystem", "key": "warning_log_channel_id", "friendly_name": "[로그] 경고 발급 기록", "channel_type": "text"},
...
STATIC_AUTO_ROLE_PANELS = {
    "panel_roles": {
        ...
        "categories": [
            {"id": "notifications", "label": "🔔 알림", "description": "받고 싶은 알림을 선택하세요.", "emoji": "🔔"},
            {"id": "games", "label": "🎮 게임", "description": "플레이하는 게임을 선택하세요.", "emoji": "🎮"},
        ],
        "roles": {
            "notifications": [
            ...
            "games": [
                ...
                {"role_id_key": "role_game_lol", "label": "리그 오브 레전드"},
                {"role_id_key": "role_game_mahjong", "label": "마작"},
                {"role_id_key": "role_game_amongus", "label": "어몽어스"},
...
TICKET_STAFF_SPECIFIC_ROLES = ["role_staff_police", "role_staff_festival", "role_staff_pr", "role_staff_design", "role_staff_secretary", "role_staff_newbie_helper"]
...
GAME_CONFIG = {
    ...
    "RPS_LOBBY_TIMEOUT": 60, "RPS_CHOICE_TIMEOUT": 45, "RPS_MAX_PLAYERS": 5, "SLOT_MAX_ACTIVE": 5,
    "XP_FROM_FISHING": 20, "XP_FROM_FARMING": 15, "XP_FROM_VOICE": 10, "XP_FROM_CHAT": 5,
...
UI_STRINGS = {
    ...
    "profile_view": {
        ...
        "seed_tab": {"no_items": "보유 중인 씨앗이 없습니다."},
        "crop_tab": {"no_items": "보유 중인 작물이 없습니다."},
        "wip_tab": {"description": "이 기능은 현재 준비 중입니다."},
...
JOB_ADVANCEMENT_DATA = {
    "50": [
        ...
        {"job_key": "farmer", "job_name": "농부", "role_key": "role_job_farmer", "description": "작물을 키우고 수확하는 데 특화된 전문가입니다.", "abilities": [{"ability_key": "farm_seed_saver_1", "ability_name": "씨앗 절약 (확률)", "description": "씨앗을 심을 때 일정 확률로 씨앗을 소모하지 않습니다."}, {"ability_key": "farm_water_retention_1", "ability_name": "수분 유지력 UP", "description": "작물이 수분을 더 오래 머금어 물을 주는 간격이 길어집니다."}]}
    ],
    "100": [
        {"job_key": "master_angler", "job_name": "강태공", "role_key": "role_job_master_angler", "description": "낚시의 길을 통달하여 전설의 물고기를 쫓는 자. 낚시꾼의 상위 직업입니다.", "prerequisite_job": "fisherman", "abilities": [{"ability_key": "fish_rare_up_2", "ability_name": "희귀어 확률 UP (대)", "description": "희귀한 물고기를 낚을 확률이 상승합니다."}, {"ability_key": "fish_size_up_2", "ability_name": "물고기 크기 UP (대)", "description": "낚는 물고기의 평균 크기가 커집니다."}]},
        {"job_key": "master_farmer", "job_name": "대농", "role_key": "role_job_master_farmer", "description": "농업의 정수를 깨달아 대지로부터 최대의 은혜를 얻는 자. 농부의 상위 직업입니다.", "prerequisite_job": "farmer", "abilities": [{"ability_key": "farm_yield_up_2", "ability_name": "수확량 UP (대)", "description": "작물을 수확할 때의 수확량이 대폭 증가합니다."}, {"ability_key": "farm_growth_speed_up_2", "ability_name": "성장 속도 UP (대)", "description": "작물의 성장 시간이 단축됩니다."}]}
    ]
}
