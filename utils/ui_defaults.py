...
UI_EMBEDS = {
    ...
    "onboarding_guide_intro": {
        ...
        # [수정] '주민 등록증' -> '자기소개'
        "description":
        "## 最後に、自己紹介を作成しましょう！\n> ### これでサーバーの案内はすべて終わりました。\n> ### 下のボタンを押して、{introduction_channel_mention}に移動し、自己紹介を作成してください。\n⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯\n提出後、職員が確認して承認すれば、正式なメンバーとして認められます。",
        "color": 0x5865F2,
        "footer": {
            "text": "7/7段階"
        }
