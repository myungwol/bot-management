...
UI_EMBEDS = {
    ...
    # ▼▼▼▼▼ [핵심 수정] 안내 스레드 임베드 전체를 4단계로 개편 ▼▼▼▼▼
    "guide_thread_page_1": {
        "description": "### 👋 안녕하세요, {user_mention}님!\n서버에 오신 것을 환영합니다!\n\n이곳은 {user_mention}님과 스태프만 대화할 수 있는 비밀의 공간이랍니다.\n\n서버에 입장하시기 전에 몇 가지 안내를 도와드리도록 하겠습니다!\n\n> 아래 '다음' 버튼을 눌러 다음 단계로 이동해주세요.",
        "color": 0x5865F2,
        "footer": { "text": "1/5 페이지" }
    },
    "guide_thread_page_2": {
        "title": "📖 꼭 알아두어야 하는 것",
        "description": "서버에서 활동을 시작하기 전, 아래의 채널은 꼭 확인해 주세요.\n### 규칙 채널\n<#1414675515759005727> :\n모든 서버원분들이 즐겁게 지내기 위한 약속을 적어두었어요.\n\n> 아래 '다음' 버튼을 눌러 다음 단계로 이동해주세요.",
        "color": 0xFEA621,
        "footer": { "text": "2/5 페이지" }
    },
    # [신규] 경로 인증 페이지
    "guide_thread_page_verification": {
        "title": "🔗 가입 경로 인증",
        "description": "서버에 어떻게 오게 되셨는지 알려주세요!\n\n디스보드, 디코 등 **서버 홍보물을 본 화면을 캡쳐**하여 이 스레드에 올려주세요.\n지인 초대로 오셨다면, **초대해 준 분과의 대화 내용**을 올려주시면 됩니다.\n\n> 아래 '다음' 버튼을 눌러 다음 단계로 이동해주세요.",
        "color": 0x3498DB,
        "footer": { "text": "3/5 페이지" }
    },
    # [신규] 디코올 추천 인증 안내 페이지
    "guide_thread_page_4": {
        "title": "👍 디코올 추천 인증",
        "description": "디코올(Dicoall)에서 저희 서버를 '추천' 해주세요!\n\n**서버 추천 후 화면을 캡쳐**하여 이 스레드에 올려주세요.\nhttps://kr.dicoall.com/server/1414625026581332112/bump\n\n> 아래 '다음' 버튼을 눌러 마지막 단계로 이동해주세요.",
        "color": 0x9B59B6,
        "footer": { "text": "4/5 페이지" }
    },
    # 기존 자기소개 페이지를 5페이지로 변경
    "guide_thread_page_5": {
        "title": "✍️ 마지막 단계: 자기소개",
        "description": "거의 다 끝나가요. 마지막으로 간단한 자기소개를 부탁드릴게요.\n\n자기소개를 작성해 주시면, 다른 분들과 더 빨리 친해질 수 있고, 스태프들이 서버 생활에 적응하는 것을 도와드리기에 용이해져요.\n\n> 아래 ‘자기소개서 작성하기’ 버튼을 눌러주세요!",
        "color": 0x2ECC71,
        "footer": { "text": "5/5 페이지" }
    },
    # ▲▲▲▲▲ [수정 완료] ▲▲▲▲▲
    ...
    "panel_relationship_roles": {
        "title": "💕 연애 여부 선택",
        "description": "### 현재 자신의 연애 상태를 선택해주세요.\n### 선택한 역할은 프로필에 표시됩니다.\n<a:06_heart:1416108354966655036> <@&1414630235873345608> \n\n<a:05_heart:1416108379650265169> <@&1414630236661878928> \n\n<a:08_heart:1416108313304629248> <@&1414630236946960495>",
        "color": 0xFF69B4
    },
    "panel_notification_roles": {
        "title": "🔔 알림 역할 선택",
        "description": "### 받고 싶은 알림을 자유롭게 선택해주세요.\n### 역할을 선택하면 관련 멘션을 받을 수 있습니다.\n<a:heart_20:1415350463238504468> <@&1414629499231928420>  \n\n<a:heart_23:1415350375720030228> <@&1414630231427514460> \n\n<a:heart_22:1415350404413390991> <@&1414629500138033182> \n\n<a:heart_24:1415350338210500718> <@&1414630232211853543>\n\n<a:heart_16:1416107199801065563> <@&1414630233168019556> \n\n<a:heart_17:1416107167299145911> <@&1414630233952489472> \n\n<a:heart_10:1416107384581132421> <@&1414630234472579253> \n\n<a:heart_14:1416107274828775454> <@&1442262367751766225>\n\n<a:heart_15:1416107239604883497> <@&1414630235252588714>\n\n<:flower_4:1421788139940479036> <@&1425118793360998461>",
        "color": 0xFFD700
    },
    "panel_game_roles": {
        "title": "🎮 게임 역할 선택",
        "description": "### 플레이하는 게임을 선택하여 파티원을 구하거나 내전에 참여해보세요!\n<:game_03:1416124421575413931> <@&1414630237446078607> \n\n<:game_04:1416124409441423390> <@&1414630238343921815> \n\n<:game_05:1416124397630128148> <@&1414630238864015432> \n\n<:game_06:1416124385651331104> <@&1416125581422235799> \n\n<:game_01:1416139027932774532> <@&1414630239568662608> \n\n<:game_02:1416139013462429756> <@&1414630239987957890>\n\n🎮 <@&1418391476437647420>\n\n<:game_03:1416124421575413931> <@&1414630634579820544> \n\n<:game_04:1416124409441423390> <@&1414630635443847198>",
        "color": 0x5865F2
    },
    "panel_onboarding": {
        "title": "📝 마을사무소・안내소",
    ...
    "embed_main_chat_welcome": {
        "title": "",
        "description": "### <a:1124928221243244644:1416125149782212831> <#1414675515759005727> 서버 규칙사항 먼저 숙지해주세요 ! \n \n ### <a:1124928273755938907:1416125162671046736> <#1421544728494604369> 역할은 여기에서 받아주세요 ! \n \n ### <:1367097758577852427:1421788139940479036> 문의 & 건의사항이 있으시다면 <#1414675593533984860> 채널을 사용해주세요 ! \n \n ### <a:1125436475631218769:1416108859956793344> 마지막으로 적응이 힘드시다면 <@&1414627893727858770> 을 멘션 해주세요 ! \n \n ### 해몽에서 즐거운 시간 되시길 바랍니다 ! <:1339999746298740788:1419558757716725760>",
        "color": 0x2ECC71
    },
    "panel_warning": {
        "title": "🚨 경고 관리 패널",
        "description":
        "서버 규칙을 위반한 유저에게 아래 버튼을 통해 경고를를 부여할 수 있습니다.\n\n**이 기능은 `고위직, 보안팀`만 사용할 수 있습니다.**",
        "color": 15548997
    },
    "log_warning": {
        "title": "🚨 경고 발급 알림",
