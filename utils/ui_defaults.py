...
UI_PANEL_COMPONENTS = [
    ...
    {"component_key": "post_anonymous_message_button", "panel_key": "anonymous_board", "component_type": "button", "label": "익명으로 전송하기", "style": "secondary", "emoji": "✍️", "row": 0, "order_in_row": 0},
