...
UI_ROLE_KEY_MAP = {
    ...
    "role_staff_newbie_helper": {"name": "도우미", "is_prefix": False, "priority": 60},
    "role_staff_police": {"name": "포장 관리팀", "is_prefix": False, "priority": 60},
...
UI_EMBEDS = {
    ...
    "panel_warning": {
        "title": "🚨 경고 관리 패널",
        "description": "서버 규칙을 위반한 유저에게 아래 버튼을 통해 벌점을 부여할 수 있습니다.\n\n**이 기능은 `포장 관리팀`만 사용할 수 있습니다.**",
        "color": 15548997
    },
    "log_warning": {
        "title": "🚨 경고 발급 알림",
    ...
    "panel_pet_exploration": {
        ...
        "color": 0x7289DA,
        "fields": [
            {"name": "🔥 불 슬라임의 둥지", "value": "> 요구 레벨: **Lv.1**", "inline": True},
            {"name": "💧 물 슬라임의 둥지", "value": "> 요구 레벨: **Lv.10**", "inline": True},
            {"name": "⚡ 전기 슬라임의 둥지", "value": "> 요구 레벨: **Lv.20**", "inline": True},
            {"name": "🌿 풀 슬라임의 둥지", "value": "> 요구 레벨: **Lv.30**", "inline": True},
            {"name": "✨ 빛 슬라임의 둥지", "value": "> 요구 레벨: **Lv.40**", "inline": True},
            {"name": "🌑 어둠 슬라임의 둥지", "value": "> 요구 레벨: **Lv.50**", "inline": True}
        ]
    },
    "panel_pet_pvp": {
        "title": "⚔️ 펫 대전장",
