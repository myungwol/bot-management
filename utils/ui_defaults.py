...
UI_EMBEDS = {
    ...
    "guide_thread_page_1": {
        ...
        "description": "과자 공장에 오신 것을 환영합니다!\n이곳은 {member_name}님과 스태프만 대화할 수 있는 비밀의 공간이랍니다.\n과자 공장 입장하시기 전에 몇 가지 안내를 도와드리도록 하겠습니다!\n\n> 아래 ‘다음’ 버튼을 눌러 안내를 계속 읽어 주세요.",
        "color": 0x5865F2,
        "footer": { "text": "1/3 페이지" }
    },
    "guide_thread_page_2": {
        "title": "📖 꼭 알아두어야 하는 것",
        "description": "과자 공장에서 활동을 시작하기 전, 아래의 채널은 꼭 확인해 주세요.\n\n**규칙 채널**\n<#1419879549847736361> : 모든 과자 공장의 베이커리분들이 즐겁게 지내기 위한 약속을 적어두었어요.",
        "color": 0xFEA621,
        "footer": { "text": "2/3 페이지" }
    },
    "guide_thread_page_3": {
        "title": "✍️ 마지막 단계: 자기 소개",
        "description": "거의 다 끝나가요. 마지막으로 간단한 자기 소개를 부탁드릴게요.\n\n자기 소개를 작성해 주시면, 베이커리들과 더 빨리 친해질 수 있고, 직원들이 서버 생활에 적응하는 것을 도와드리기에 용이해져요.\n\n> 아래 ‘자기소개서 작성하기’ 버튼을 눌러주세요!",
        "color": 0x2ECC71,
        "footer": { "text": "3/3 페이지" }
    },
