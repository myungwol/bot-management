...
UI_EMBEDS = {
    ...
    # ▼▼▼▼▼ [추가] 안내 스레드 내부 환영 임베드 ▼▼▼▼▼
    "guide_thread_page_1": {
        "title": "👋 안녕하세요, {member_name}님!",
        "description": "우리 마을에 오신 것을 진심으로 환영합니다!\n\n이곳은 {member_name}님과 스태프만 대화할 수 있는 비밀 공간이에요.\n제가 몇 가지 안내를 도와드릴게요.\n\n> 아래 '다음' 버튼을 눌러 안내를 계속 읽어주세요.",
        "color": 0x5865F2,
        "footer": { "text": "1/3 페이지" }
    },
    "guide_thread_page_2": {
        "title": "📜 꼭 알아두어야 할 것들",
        "description": "마을 생활을 시작하기 전에, 아래 두 채널은 꼭 한번 확인해주세요!\n\n**1. 규칙 채널**\n> <#1412052221209608273> : 모든 주민이 즐겁게 지내기 위한 약속이에요.\n\n**2. 역할 채널**\n> <#1412052301115424799> : 서버 알림이나 게임 친구를 찾는 등 다양한 역할을 받을 수 있어요.",
        "color": 0xFEA621,
        "footer": { "text": "2/3 페이지" }
    },
    "guide_thread_page_3": {
        "title": "📝 마지막 단계: 자기소개",
        "description": "이제 거의 다 끝났어요! 마지막으로 간단한 자기소개를 부탁드릴게요.\n\n자기소개를 작성해주시면, 다른 주민들과 더 빨리 친해질 수 있고 스태프들이 서버 생활에 적응하는 것을 도와드리기 용이해져요.\n\n> 아래 **'자기소개서 작성하기'** 버튼을 눌러주세요!",
        "color": 0x2ECC71,
        "footer": { "text": "3/3 페이지" }
    },
