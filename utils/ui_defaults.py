...
UI_EMBEDS = {
    ...
    "panel_fishing": {"title": "🎣 釣り場", "description": ("のんびり釣りを楽しみましょう。\n" "「釣りをする」ボタンで釣りを開始します。"), "color": 0x5865F2},
    ...
    "embed_shop_buy": {"title": "🏪 Dico森商店 - 「{category}」", "description": "現在の所持金: `{balance}`{currency_icon}", "color": 0x3498DB},
    "embed_shop_sell": {"title": "📦 販売所 - 「{category}」", "description": "現在の所持金: `{balance}`{currency_icon}", "color": 0xE67E22}
}
...
UI_PANEL_COMPONENTS = [
    ...
    {"component_key": "start_fishing", "panel_key": "fishing", "component_type": "button", "label": "釣りをする", "style": "primary", "emoji": "🎣", "row": 0},
    {"component_key": "request_nickname_change", "panel_key": "nicknames", "component_type": "button", "label": "名前変更申請", "style": "primary", "emoji": "✒️", "row": 0},
    {"component_key": "open_inventory", "panel_key": "profile", "component_type": "button", "label": "持ち物を開く", "style": "primary", "emoji": "📦", "row": 0},
]
...
SETUP_COMMAND_MAP = {
    ...
    # [수정] 게임 관련 패널은 나중에 게임 봇에서 관리하도록 주석 처리
