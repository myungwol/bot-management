...
class TicketSystem(commands.Cog):
    ...
    async def regenerate_panel(self, channel: discord.ForumChannel):
        panel_type = None
        ...
        if panel_type:
            ...
            # 포럼 채널에는 시작용 게시물(스레드)을 만들어서 패널을 설치
            await channel.create_thread(name=f"チケット作成はこちらから", embed=embed, view=view)
